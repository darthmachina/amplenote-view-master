const plugin = 
{
  ...
  _getSettings(content, appSettings) {
    ...
    // Check app settings and default to constant value if it's not set
    const defaultImageWidth = appSettings[this.constants.settingImageWidthName] || this.constants.defaultImageWidth;
    const defaultTableColumns = appSettings[this.constants.settingTableColumnsName] || this.constants.defaultTableColumns;
    ...
    return new this.Settings(
      ...
      (imageWidthMatches) ? imageWidthMatches[1] : defaultImageWidth,
      (tableColumnsMatches) ? tableColumnsMatches[1] : defaultTableColumns
    );
  },
