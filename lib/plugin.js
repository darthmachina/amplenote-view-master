const plugin = 
{
  ...
  constants: {
    ...
    inlineFieldRegexp: RegExp("[ -]?([a-zA-Z]*) ?:: ?([a-zA-Z\\[]?[a-zA-Z\\]\\(:/\\.0-9-) ]*)[ ]?$")
  },
  ...
  _getInlineFields(content) {
    ...
    var fields = {};
    var match = this.constants.inlineFieldRegexp.exec(content);
    console.log(`match: ${match[0]}`);
    // while(match = this.constants.inlineFieldRegexp.exec(content) !== null) {
