const plugin = 
{
  ...
  Settings: class {
    constructor(queryTag, groupTags, imageWidth, tableColumns, includeFields, sortBy, displayAs, progressCompletion, progressRemaining) {
    ...
    copy(
      ...
      return new Settings(queryTag, groupTags, imageWidth, tableColumns, includeFields, sortBy, displayAs, progressCompletion, progressRemaining);
    }
  },
