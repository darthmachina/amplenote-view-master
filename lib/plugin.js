const plugin = 
{
  ...
  Settings: class {
    constructor(queryTag, groupTags, imageWidth, tableColumns, includeFields) {
  ...
  _getSettings(content, appSettings) {
    ...
    console.log(`include fields: ${JSON.stringify(includeFieldsMatches)}`);
